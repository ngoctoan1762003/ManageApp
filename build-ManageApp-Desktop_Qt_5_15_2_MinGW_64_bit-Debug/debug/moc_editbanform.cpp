/****************************************************************************
** Meta object code from reading C++ file 'editbanform.h'
**
...
#include <memory>
#include "../../ManageApp/editbanform.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'editbanform.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_EditBanForm_t, stringdata0) + ofs \
...
static const uint qt_meta_data_EditBanForm[] = {
...
QT_INIT_METAOBJECT const QMetaObject EditBanForm::staticMetaObject = { {
    ...
    qt_meta_stringdata_EditBanForm.data,
    qt_meta_data_EditBanForm,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *EditBanForm::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *EditBanForm::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_EditBanForm.stringdata0))
