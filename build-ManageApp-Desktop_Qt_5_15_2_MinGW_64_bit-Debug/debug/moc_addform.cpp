...
QT_MOC_LITERAL(1, 8, 5), // "addMH"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 8), // "MonHang*"
QT_MOC_LITERAL(4, 24, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(5, 46, 21) // "on_buttonBox_rejected"

    },
    "AddForm\0addMH\0\0MonHang*\0on_buttonBox_accepted\0"
...
void AddForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addMH((*reinterpret_cast< MonHang*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (AddForm::*)(MonHang * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddForm::addMH)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AddForm::addMH(MonHang * _t1)
{
